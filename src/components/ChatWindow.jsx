...
export default function ChatWindow({ isOpen, inboxId, visitorId, onClose }) {
  ...
  // ---- 初始化会话 ----
  useEffect(() => {
    if (!isOpen || !inboxId || !visitorId) return;
  ...
  }, [isOpen, inboxId, visitorId, sessionReady, loadHistory, connectWebSocket, scrollToBottom]);
  ...
  return (
    <div className="chat-view">
      ...
      <div className="chat-view__header">
        <div className="chat-view__header-title"></div>
        <IconClose
          size="large"
      ...
      <div className="chat-view__body">
        {isInitLoading && (
          <div className="chat-view__init-loading">
            Connecting...
          </div>
        )}
        <div className={`chat-view__messages ${isMessagesVisible ? 'chat-view__messages--visible' : ''}`}>
      ...
      <div className="chat-view__footer">
        <div className="chat-view__quick-actions-float">
          {quickActions.map((action) => (
            <button
              key={action.key}
              type="button"
              className="chat-view__quick-btn"
